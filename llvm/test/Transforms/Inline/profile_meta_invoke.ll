...
!16 = !{!"VP", i32 0, i64 1000, i32 2, i64 9191153033785521275, i64 400, i64 -1069303473483922844, i64 600}
!17 = !{!"branch_weights", i32 500}

; CHECK-LABEL: @caller(
; CHECK:  invoke void %func()
; CHECK-NEXT: {{.*}} !prof ![[PROF:[0-9]+]]
; CHECK: ![[PROF]] = !{!"VP", i32 0, i64 500, i32 2, i64 9191153033785521275, i64 200, i64 -1069303473483922844, i64 300}
