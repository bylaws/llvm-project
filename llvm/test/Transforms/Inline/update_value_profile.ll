...
!15 = !{!"VP", i32 2, i64 1600, i32 2, i64 321, i64 1000, i64 789, i64 600}
!16 = !{!"VP", i32 0, i64 1600, i32 2, i64 123, i64 1000, i64 456, i64 600}
...
; CHECK: [[PROF1]] = !{!"VP", i32 2, i64 94, i32 2, i64 321, i64 58, i64 789, i64 35}
; CHECK: [[PROF2]] = !{!"VP", i32 0, i64 94, i32 2, i64 123, i64 58, i64 456, i64 35}
; CHECK: [[PROF3]] = !{!"function_entry_count", i64 1000}
; CHECK: [[PROF4]] = !{!"VP", i32 2, i64 941, i32 2, i64 321, i64 588, i64 789, i64 352}
; CHECK: [[PROF5]] = !{!"VP", i32 0, i64 941, i32 2, i64 123, i64 588, i64 456, i64 352}
; CHECK: [[PROF6]] = !{!"function_entry_count", i64 600}
; CHECK: [[PROF7]] = !{!"VP", i32 2, i64 564, i32 2, i64 321, i64 352, i64 789, i64 211}
; CHECK: [[PROF8]] = !{!"VP", i32 0, i64 564, i32 2, i64 123, i64 352, i64 456, i64 211}
;.
