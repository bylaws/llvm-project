...
; Multi-kind VP metadata node:
; Entry 1: kind=0 (IPVK_IndirectCallTarget), total=500, 1 entry, hash=12345678, count=400
; Entry 2: kind=3 (IPVK_ArgumentValue), total=1000, 1 entry, value=42, count=800
!29 = !{!"VP",
  i32 0, i64 500, i32 1, i64 12345678, i64 400,
  i32 3, i64 1000, i32 1, i64 42, i64 800}
